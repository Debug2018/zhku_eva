    ...
    <el-container>
      <el-header>
        ...
        >
          ...
          <el-menu-item index="2">合并Excel表格&排序</el-menu-item>

          <el-menu-item index="3">综测自动评判</el-menu-item>

          <el-menu-item index="4">详细使用文档</el-menu-item>

          <el-menu-item index="5">综合测评管理办法</el-menu-item>
        </el-menu>
      </el-header>
      <el-main>
        <router-view />
...
//   components: { home, mergeExcel, selectGood },
